...
#
# File    : raccel_vcx64.tmf   $Revision: 1.1.6.26 $
#
# Abstract:
...
MODEL                  = simu
MODULES                = rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c simu_data.c 
MAKEFILE               = simu.mk
MATLAB_ROOT            = C:\Program Files\MATLAB\R2012b
ALT_MATLAB_ROOT        = C:\PROGRA~1\MATLAB\R2012b
MATLAB_BIN             = C:\Program Files\MATLAB\R2012b\bin
ALT_MATLAB_BIN         = C:\PROGRA~1\MATLAB\R2012b\bin
MASTER_ANCHOR_DIR      = 
START_DIR              = C:\Users\Felipe\Dropbox\ACIONA~1\Pessoal\Felipe\Matlab\teste03
S_FUNCTIONS            = 
S_FUNCTIONS_LIB        = 
...
NCSTATES            = 2
MULTITASKING        = 0
PCMATLABROOT        = C:\\Program Files\\MATLAB\\R2012b
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\raccel\simu
...
!endif
!if "$(RACCEL_PARALLEL_EXECUTION)" == "1"
MAT_LIBS = $(MAT_LIBS) $(MATLAB_ROOT)\extern\lib\win64\microsoft\libmwslexec_cgparallel.lib
!endif
