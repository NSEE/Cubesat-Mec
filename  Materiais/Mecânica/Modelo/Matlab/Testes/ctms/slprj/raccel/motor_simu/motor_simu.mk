...
#
# File    : raccel_vc.tmf   $Revision: 1.1.6.18 $
#
# Abstract:
...
MODEL                  = motor_simu
MODULES                = motor_simu_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE               = motor_simu.mk
...
MASTER_ANCHOR_DIR      = 
START_DIR              = C:\Users\Felipe\Dropbox\Acionamento Motor BLDC\Pessoal\Felipe\Matlab\ctms
S_FUNCTIONS            = 
S_FUNCTIONS_LIB        = 
...
RACCEL_PARFOREACH_NUM_THREADS = 2
...
MODELLIB                  = motor_simulib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = motor_simu_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\raccel\motor_simu
...
# Add flags to generate the pdb file if -DGEN_PDB=1 is specified
GEN_PDB = 0
!if $(GEN_PDB) == 1
CPP_REQ_DEFINES = $(CPP_REQ_DEFINES) /Zi /Fd"$(MODEL).pdb"
!endif

# Uncomment this line to move warning level to W4
# cflags = $(cflags:W3=W4)
CFLAGS   = $(MODELREF_INC_PATH) $(cflags) $(cvarsmt) $(PARAM_CC_OPTS) \
	   $(CFLAGS_VERSPECIFIC) $(CC_OPTS) $(CPP_REQ_DEFINES) $(USER_INCLUDES)
CPPFLAGS = $(MODELREF_INC_PATH) $(cflags) $(cvarsmt) $(PARAM_CC_OPTS) \
	   $(CPPFLAGS_VERSPECIFIC) $(CPP_OPTS) $(CC_OPTS) $(CPP_REQ_DEFINES) \
	   $(USER_INCLUDES)

!if $(GEN_PDB) == 1
LDFLAGS  = /DEBUG /PDB:"$(MODEL).pdb"
!else
LDFLAGS  = $(ldebug)
!endif
LDFLAGS  = $(LDFLAGS) $(conflags) $(EXT_LIB) $(conlibs) $(ADDITIONAL_LDFLAGS)
...
MAT_LIBS = $(MATLAB_ROOT)\extern\lib\win32\microsoft\libut.lib \
           $(MATLAB_ROOT)\extern\lib\win32\microsoft\libmx.lib \
           $(MATLAB_ROOT)\extern\lib\win32\microsoft\libmat.lib \
	   $(MATLAB_ROOT)\extern\lib\win32\microsoft\libmwmathutil.lib \
           $(MATLAB_ROOT)\extern\lib\win32\microsoft\libmwsl_solver_rtw.lib \
           $(MATLAB_ROOT)\extern\lib\win32\microsoft\libmwsl_fileio.lib
