...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . oovwbqjh43
) , 0 , 0 , 4 } , { ( char_T * ) ( & rtDWork . mzr4adu30a . LoggedData ) , 11
, 0 , 3 } , { ( char_T * ) ( & rtDWork . edwmkoqjaw ) , 10 , 0 , 1 } } ;
static DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ;
static DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
Integrator1_IC ) , 0 , 0 , 9 } } ; static DataTypeTransitionTable
